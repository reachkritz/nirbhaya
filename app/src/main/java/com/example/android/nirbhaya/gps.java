...
public class gps extends FragmentActivity implements
    ...
    public String handleNewLocat(Location location) {
        Log.d(TAG, location.toString());

        double currentLatitude = location.getLatitude();
        double currentLongitude = location.getLongitude();
        Toast.makeText(this, "LONG:" + currentLongitude + "\nLATI:" + currentLatitude, Toast.LENGTH_LONG).show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.android.nirbhaya/http/host/path")
        );
